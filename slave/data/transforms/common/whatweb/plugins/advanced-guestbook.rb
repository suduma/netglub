...
matches [
{:name=>"GHDB: title & powered by", 
:probability=>75,
:ghdb=>'intitle:guestbook "advanced guestbook 2.2" powered'},

{:name=>"Thank you for stopping by my site. Here you can leave your mark.", 
:probability=>75,
...
def passive
	...
	if @body =~ /<a href="http:\/\/www.proxy2.de" target="_blank"><font color="#CCCCCC" size="1">Advanced Guestbook ([^<]+)/
		version=@body.scan(/<a href="http:\/\/www.proxy2.de" target="_blank"><font color="#CCCCCC" size="1">(Advanced Guestbook) ([^<]+)/)[0][1]
