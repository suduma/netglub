...
{:name=>"Powered by",
:probability=>100,
:regexp=>/(Powered by|Propuls&#233; par) (<strong>)?<a href="http:\/\/fluxbb.org\/">FluxBB<\/a>/},

# default styles - Cobalt.css  imports  index.html  Lithium.css  Mercury.css  Oxygen.css  Radium.css  Sulfur.css

{:name=>"Default stylesheets= Cobalt|Lithium|Mercury|Oxygen|Radium|Sulfur",
:probability=>25,
:regexp=>/<link rel="stylesheet" type="text\/css" href="style\/(Cobalt|Lithium|Mercury|Oxygen|Radium|Sulfur).css" \/>
/},
...
{:name=>"brdwelcome",
:probability=>75,
:regexp=>/<div id="brdwelcome" class="inbox">\s+<p>[^<]+<\/p>\s+<\/div>/}
]
...
unless version.nil?
	m << {:name=>"md5 sums of files", :probability=>100, :version=>version}
end	
m
end
