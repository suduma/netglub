...
BlockLayout::BlockLayout(Graph* graph,AbstractLayout::ViewMod viewMod,  AbstractLayout::GroupMod groupMod) : AbstractLayout(graph,viewMod,groupMod)
{
}

QRectF BlockLayout::layout()
{
   QTime t;
   t.start();
