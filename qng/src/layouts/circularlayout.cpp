...
CircularLayout::CircularLayout(Graph* graph,AbstractLayout::ViewMod viewMod, AbstractLayout::GroupMod groupMod, AbstractLayout::SpanMod spanMod) : AbstractLayout(graph,viewMod,groupMod, spanMod)
{
}

QRectF CircularLayout::layout()
{
    ...
    gvLayout(pConnectedComponent->_gvC,pConnectedComponent->_gvG,(char*)"fdp");
